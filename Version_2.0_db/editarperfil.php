				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="name" class="form-control <?= isset($errorsInEdit['name']) ? 'is-invalid' : null ?>" value="<?= $name; ?>">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="email" class="form-control <?= isset($errorsInEdit['email']) ? 'is-invalid' : null ?>" value="<?= $email; ?>" readonly>
							<div class="invalid-feedback">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="password" name="password" class="form-control <?= isset($errorsInEdit['password']) ? 'is-invalid' : null ?>">
							<div class="invalid-feedback">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="password" name="rePassword" class="form-control <?= isset($errorsInEdit['rePassword']) ? 'is-invalid' : null; ?>">
							<div class="invalid-feedback">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="country" class="form-control <?= isset($errorsInEdit['country']) ? 'is-invalid' : null; ?>">
								<option value="">Elegí un país</option>
								<?php foreach ($countries as $code => $country) : ?>
									<option value="<?= $code ?>" <?= $code == $userCountry ? 'selected' : null; ?>>
										<?= $country ?>
									</option>
								<?php endforeach; ?>
							</select>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="file" name="avatar" class="custom-file-input <?= isset($errorsInEdit['avatar']) ? 'is-invalid' : null; ?>">
